-- Active: 1728117029218@@127.0.0.1@3306@dit
Create DATABASE DIT;
use DIT;
show DATABASEs;
...
SELECT * FROM patient order BY `Pname` DESC;
SELECT * FROM patient WHERE `Address`= 'kampala'OR 'fees'= 40000;
SELECT * FROM patient WHERE `Address` NOT IN ('kampala','Null');
SELECT * FROM patient WHERE `Address` IN ('kampala','Null'); 
SELECT COUNT (*) FROM patient WHERE `Address`= 'Entebbe';
SELECT * FROM patient WHERE `Pname` LIKE 'T%';
SELECT * FROM patient WHERE 'Pname' LIKE '%o';
SELECT * FROM patient WHERE `Pname` < 'Tom';
SELECT * FROM patient where `Address`!='kampala';
SELECT * FROM patient WHERE `Fees` BETWEEN 40000 AND 60000;
SELECT * FROM patient WHERE `PID` NOT IN ('POO1','P002');
SELECT * FROM patient WHERE `PID` IN ('POO1','P002');
SELECT * FROM patient WHERE `PID` = 'P001';
SELECT * FROM patient WHERE `PID` = 'POO1' OR 'P002';